...
export let bootstrap = () => {
  ...
  RkTheme.setType('RkText', 'default', {
    fontFamily: theme => theme.fonts.family.regular,
    color: '#2C3134'
  });
  ...
  RkTheme.setType('RkText', 'addVehicle', {
    color: 'black'
  });

  RkTheme.setType('RkText', 'titleNavBar', {
    color: 'white',
    fontSize: 16
  });
  RkTheme.setType('RkText', 'subTitleNavBar', {
    color: '#C0C0C0'
  });

  RkTheme.setType('RkText', 'label-red', {
    text: {
  ...
  RkTheme.setType('RkText', 'label-orange', {
    text: {
  ...
  RkTheme.setType('RkText', 'label-green', {
    text: {
      backgroundColor: '#02C867',
      paddingHorizontal: 5,
      paddingVertical: 2,
      color: 'white'
    }
  });
  RkTheme.setType('RkText', 'label-grey', {
    text: {
  ...
  RkTheme.setType('RkText', 'label-blue', {
    text: {
  ...
  RkTheme.setType('RkButton', 'default', {
    container: {
      alignSelf: 'auto',
    },
    fontSize: theme => theme.fonts.sizes.s6,
